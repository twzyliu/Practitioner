...
public class TestHelper {
    ...
    public static final int ENOUGH_TOOLS = 5;
    public static final int LAND_PRICE = 200;
    public static final String WRONG_CMD = "wrong_cmd";
    public static final String EXIT_CMD = "F";
    public static final String CHOSE_ONE = "1";
    ...
    public static final String INIT_PLAYER_CMD = "12";
}
